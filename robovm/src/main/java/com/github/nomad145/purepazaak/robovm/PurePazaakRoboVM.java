package com.github.nomad145.purepazaak.robovm;
...
public class PurePazaakRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, PurePazaakRoboVM.class);
    pool.close();
  }
}
